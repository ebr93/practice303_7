 ...
 * and , as parameters and finds . If either  or  is negative, then the method must throw an exception 
 * which says "". Also, if both  and  are zero, then the method must throw an exception which says ""
	...
	Each line of the input contains two integers,  and . The locked stub code in the editor 
	...
	Each line of the output contains the result , if both  and  are positive. If either  or  is negative, 
	the output contains "n and p should be non-negative". If both  and  are zero, the output 
	contains "n and p should not be zero.". This is printed by the locked stub code in the editor.
 * 
 */

public class HackerRankExceptionsTwo {
